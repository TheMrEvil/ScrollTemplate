...
namespace System.Security.Cryptography.Pkcs.Asn1
{
	...
	{
		// Token: 0x06000517 RID: 1303 RVA: 0x00014B68 File Offset: 0x00012D68
		internal Rc2CbcParameters(ReadOnlyMemory<byte> iv, int keySize)
		{
			if (keySize > 255)
			{
				this.Rc2Version = keySize;
			}
			else
			{
				this.Rc2Version = (int)Rc2CbcParameters.s_rc2EkbEncoding[keySize];
			}
			this.Iv = iv;
		}

		// Token: 0x06000518 RID: 1304 RVA: 0x00014B8F File Offset: 0x00012D8F
		...
		// Token: 0x06000519 RID: 1305 RVA: 0x00014BB6 File Offset: 0x00012DB6
