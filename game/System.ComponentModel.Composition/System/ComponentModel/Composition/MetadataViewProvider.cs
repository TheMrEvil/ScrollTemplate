			...
			catch (TargetInvocationException ex)
			{
				if (typeFromHandle.IsInterface)
				{
					if (ex.InnerException.GetType() == typeof(InvalidCastException))
					{
						...
						{
							ex.InnerException.Data["MetadataViewType"],
							ex.InnerException.Data["MetadataItemKey"],
							ex.InnerException.Data["MetadataItemValue"],
							ex.InnerException.Data["MetadataItemSourceType"],
