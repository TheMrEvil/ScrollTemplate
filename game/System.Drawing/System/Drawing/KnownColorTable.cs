...
namespace System.Drawing
{
	...
	internal static class KnownColorTable
	{
		...
		public static Color ArgbToKnownColor(int targetARGB)
		{
			...
			for (int i = 0; i < KnownColorTable.s_colorTable.Length; i++)
			{
				if (KnownColorTable.s_colorTable[i] == targetARGB)
				{
		...
		{
			if (KnownColorTable.s_colorTable == null)
			{
		...
		private static void InitColorTable()
		{
			...
			array[166] = -256;
			array[167] = -6632142;
			KnownColorTable.s_colorTable = array;
		}

		// Token: 0x0600002C RID: 44 RVA: 0x00002B25 File Offset: 0x00000D25
		private static void EnsureColorNameTable()
		{
			if (KnownColorTable.s_colorNameTable == null)
			{
		...
		private static void InitColorNameTable()
		{
			...
			KnownColorTable.s_colorNameTable = array;
		}

		// Token: 0x0600002E RID: 46 RVA: 0x000031F3 File Offset: 0x000013F3
		public static int KnownColorToArgb(KnownColor color)
		{
			KnownColorTable.EnsureColorTable();
			return KnownColorTable.s_colorTable[(int)color];
		}

		// Token: 0x0600002F RID: 47 RVA: 0x00003201 File Offset: 0x00001401
		public static string KnownColorToName(KnownColor color)
		{
			KnownColorTable.EnsureColorNameTable();
			return KnownColorTable.s_colorNameTable[(int)color];
		}
