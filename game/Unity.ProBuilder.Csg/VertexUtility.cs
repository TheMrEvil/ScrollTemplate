...
namespace UnityEngine.ProBuilder.Csg
{
	...
	internal static class VertexUtility
	{
		...
		{
			VertexUtility.GetArrays(vertices, out position, out color, out uv0, out normal, out tangent, out uv2, out uv3, out uv4, VertexAttributes.All);
		}

		// Token: 0x06000045 RID: 69 RVA: 0x00002E98 File Offset: 0x00001098
		...
		// Token: 0x06000047 RID: 71 RVA: 0x000032D4 File Offset: 0x000014D4
		public static void SetMesh(Mesh mesh, IList<Vertex> vertices)
		{
			...
			VertexUtility.GetArrays(vertices, out vertices2, out colors, out uv, out normals, out tangents, out uv2, out list, out list2);
			mesh.Clear();
		...
		// Token: 0x06000048 RID: 72 RVA: 0x000033CC File Offset: 0x000015CC
		public static Vertex Mix(this Vertex x, Vertex y, float weight)
		{
			float num = 1f - weight;
			Vertex result = default(Vertex);
			result.position = x.position * num + y.position * weight;
		...
		// Token: 0x06000049 RID: 73 RVA: 0x000036F8 File Offset: 0x000018F8
