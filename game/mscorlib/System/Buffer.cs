...
namespace System
{
	...
	public static class Buffer
	{
		...
		// Token: 0x0600153B RID: 5435 RVA: 0x000533B0 File Offset: 0x000515B0
		[SecurityCritical]
		...
		// Token: 0x0600153D RID: 5437 RVA: 0x00053474 File Offset: 0x00051674
		[SecurityCritical]
		...
		// Token: 0x0600153E RID: 5438 RVA: 0x0005348C File Offset: 0x0005168C
		[SecurityCritical]
		...
		internal unsafe static void Memcpy(byte[] dest, int destIndex, byte* src, int srcIndex, int len)
		{
			...
			fixed (byte[] array = dest)
			{
				...
				Buffer.Memcpy(ptr + destIndex, src + srcIndex, len, true);
			}
		}

		// Token: 0x0600153F RID: 5439 RVA: 0x000534C8 File Offset: 0x000516C8
		[SecurityCritical]
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.Success)]
		internal unsafe static void Memcpy(byte* pDest, int destIndex, byte[] src, int srcIndex, int len)
		{
			...
			fixed (byte[] array = src)
			{
				...
				Buffer.Memcpy(pDest + destIndex, ptr + srcIndex, len, true);
			}
		}
		...
		// Token: 0x06001541 RID: 5441 RVA: 0x00053502 File Offset: 0x00051702
		...
		/// <exception cref="T:System.OverflowException">
		///   <paramref name="array" /> is larger than 2 gigabytes (GB).</exception>
		// Token: 0x06001542 RID: 5442 RVA: 0x00053527 File Offset: 0x00051727
		...
		/// <exception cref="T:System.OverflowException">
		///   <paramref name="array" /> is larger than 2 gigabytes (GB).</exception>
		// Token: 0x06001543 RID: 5443 RVA: 0x00053553 File Offset: 0x00051753
		...
		// Token: 0x06001544 RID: 5444 RVA: 0x00053580 File Offset: 0x00051780
		...
		// Token: 0x06001545 RID: 5445 RVA: 0x00053618 File Offset: 0x00051818
		[CLSCompliant(false)]
		...
		/// <exception cref="T:System.ArgumentOutOfRangeException">
		///   <paramref name="sourceBytesToCopy" /> is greater than <paramref name="destinationSizeInBytes" />.</exception>
		// Token: 0x06001546 RID: 5446 RVA: 0x0005365C File Offset: 0x0005185C
		[CLSCompliant(false)]
		...
		// Token: 0x06001547 RID: 5447 RVA: 0x000536A0 File Offset: 0x000518A0
		...
		// Token: 0x06001548 RID: 5448 RVA: 0x00053720 File Offset: 0x00051920
		...
		// Token: 0x06001549 RID: 5449 RVA: 0x0005378C File Offset: 0x0005198C
		...
		// Token: 0x0600154A RID: 5450 RVA: 0x00053814 File Offset: 0x00051A14
		...
		// Token: 0x0600154B RID: 5451 RVA: 0x000538AE File Offset: 0x00051AAE
		internal unsafe static void Memmove(byte* dest, byte* src, uint len)
		{
			if ((ulong)(dest - src) >= (ulong)len && (ulong)(src - dest) >= (ulong)len)
			{
				Buffer.Memcpy(dest, src, (int)len, true);
				return;
			}
			RuntimeImports.Memmove(dest, src, len);
		}

		// Token: 0x0600154C RID: 5452 RVA: 0x000538D4 File Offset: 0x00051AD4
