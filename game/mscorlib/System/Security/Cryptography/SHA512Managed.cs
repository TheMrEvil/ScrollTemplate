...
namespace System.Security.Cryptography
{
	...
	public class SHA512Managed : SHA512
	{
		...
		// Token: 0x06003063 RID: 12387 RVA: 0x000B039C File Offset: 0x000AE59C
		...
		// Token: 0x06003064 RID: 12388 RVA: 0x000B03F5 File Offset: 0x000AE5F5
		...
		// Token: 0x06003065 RID: 12389 RVA: 0x000B0425 File Offset: 0x000AE625
		...
		// Token: 0x06003066 RID: 12390 RVA: 0x000B0430 File Offset: 0x000AE630
		[SecuritySafeCritical]
		...
		// Token: 0x06003067 RID: 12391 RVA: 0x000B0438 File Offset: 0x000AE638
		...
		// Token: 0x06003068 RID: 12392 RVA: 0x000B04D8 File Offset: 0x000AE6D8
		[SecurityCritical]
		...
		// Token: 0x06003069 RID: 12393 RVA: 0x000B0604 File Offset: 0x000AE804
		[SecurityCritical]
		...
		// Token: 0x0600306A RID: 12394 RVA: 0x000B06F8 File Offset: 0x000AE8F8
		[SecurityCritical]
		...
		// Token: 0x0600306B RID: 12395 RVA: 0x000B027D File Offset: 0x000AE47D
		private static ulong RotateRight(ulong x, int n)
		{
			return x >> n | x << 64 - n;
		}

		// Token: 0x0600306C RID: 12396 RVA: 0x000B028F File Offset: 0x000AE48F
		private static ulong Ch(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ ((x ^ ulong.MaxValue) & z);
		}

		// Token: 0x0600306D RID: 12397 RVA: 0x000AFAF6 File Offset: 0x000ADCF6
		private static ulong Maj(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x0600306E RID: 12398 RVA: 0x000B0A15 File Offset: 0x000AEC15
		private static ulong Sigma_0(ulong x)
		{
			return SHA512Managed.RotateRight(x, 28) ^ SHA512Managed.RotateRight(x, 34) ^ SHA512Managed.RotateRight(x, 39);
		}

		// Token: 0x0600306F RID: 12399 RVA: 0x000B0A31 File Offset: 0x000AEC31
		private static ulong Sigma_1(ulong x)
		{
			return SHA512Managed.RotateRight(x, 14) ^ SHA512Managed.RotateRight(x, 18) ^ SHA512Managed.RotateRight(x, 41);
		}

		// Token: 0x06003070 RID: 12400 RVA: 0x000B0A4D File Offset: 0x000AEC4D
		private static ulong sigma_0(ulong x)
		{
			return SHA512Managed.RotateRight(x, 1) ^ SHA512Managed.RotateRight(x, 8) ^ x >> 7;
		}

		// Token: 0x06003071 RID: 12401 RVA: 0x000B0A62 File Offset: 0x000AEC62
		private static ulong sigma_1(ulong x)
		{
			return SHA512Managed.RotateRight(x, 19) ^ SHA512Managed.RotateRight(x, 61) ^ x >> 6;
		}

		// Token: 0x06003072 RID: 12402 RVA: 0x000B0A7C File Offset: 0x000AEC7C
		[SecurityCritical]
		...
		// Token: 0x06003073 RID: 12403 RVA: 0x000B0AD1 File Offset: 0x000AECD1
