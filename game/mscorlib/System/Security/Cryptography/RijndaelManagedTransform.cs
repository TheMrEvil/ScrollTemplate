...
namespace System.Security.Cryptography
{
	...
	{
		// Token: 0x06002F8A RID: 12170 RVA: 0x000A925C File Offset: 0x000A745C
		...
		// Token: 0x06002F8B RID: 12171 RVA: 0x000A95D9 File Offset: 0x000A77D9
		public void Dispose()
		{
			this.Dispose(true);
		}
		...
		// Token: 0x06002F8C RID: 12172 RVA: 0x000A95D9 File Offset: 0x000A77D9
		public void Clear()
		{
			this.Dispose(true);
		}

		// Token: 0x06002F8D RID: 12173 RVA: 0x000A95E4 File Offset: 0x000A77E4
		...
		// (get) Token: 0x06002F8E RID: 12174 RVA: 0x000A96C9 File Offset: 0x000A78C9
		...
		// (get) Token: 0x06002F8F RID: 12175 RVA: 0x000A96D1 File Offset: 0x000A78D1
		...
		// (get) Token: 0x06002F90 RID: 12176 RVA: 0x000A96D9 File Offset: 0x000A78D9
		...
		// Token: 0x06002F93 RID: 12179 RVA: 0x000A96E4 File Offset: 0x000A78E4
		...
		// Token: 0x06002F94 RID: 12180 RVA: 0x000A9860 File Offset: 0x000A7A60
		...
		// Token: 0x06002F95 RID: 12181 RVA: 0x000A9984 File Offset: 0x000A7B84
		public void Reset()
		{
			this.m_depadBuffer = null;
			if (this.m_cipherMode == CipherMode.CBC)
		...
		// Token: 0x06002F96 RID: 12182 RVA: 0x000A99E0 File Offset: 0x000A7BE0
			...
			for (int j = 0; j < num4; j++)
			{
				...
				else
				{
					...
					if (this.m_cipherMode == CipherMode.CBC)
					{
						...
						Buffer.Memcpy((byte*)dest, (byte*)ptr2, this.m_blockSizeBytes, true);
						array7 = null;
					}
				}
		...
		// Token: 0x06002F97 RID: 12183 RVA: 0x000AA078 File Offset: 0x000A8278
		[SecuritySafeCritical]
		...
		// Token: 0x06002F98 RID: 12184 RVA: 0x000AA758 File Offset: 0x000A8958
		[SecurityCritical]
		...
		// Token: 0x06002F99 RID: 12185 RVA: 0x000AA948 File Offset: 0x000A8B48
		[SecurityCritical]
		...
		// Token: 0x06002F9A RID: 12186 RVA: 0x000AAB64 File Offset: 0x000A8D64
		...
		// Token: 0x06002F9B RID: 12187 RVA: 0x000AAE34 File Offset: 0x000A9034
		private static int rot1(int val)
		{
			return (val << 8 & -256) | (val >> 24 & 255);
		}

		// Token: 0x06002F9C RID: 12188 RVA: 0x000AAE4A File Offset: 0x000A904A
		private static int rot2(int val)
		{
			return (val << 16 & -65536) | (val >> 16 & 65535);
		}

		// Token: 0x06002F9D RID: 12189 RVA: 0x000AAE61 File Offset: 0x000A9061
		private static int rot3(int val)
		{
			return (val << 24 & -16777216) | (val >> 8 & 16777215);
		}

		// Token: 0x06002F9E RID: 12190 RVA: 0x000AAE78 File Offset: 0x000A9078
		...
		// Token: 0x06002F9F RID: 12191 RVA: 0x000AAECC File Offset: 0x000A90CC
		...
		// Token: 0x06002FA0 RID: 12192 RVA: 0x000AAEFC File Offset: 0x000A90FC
