...
namespace System.Security.Cryptography
{
	...
	public class SHA256Managed : SHA256
	{
		...
		// Token: 0x0600303B RID: 12347 RVA: 0x000AF4A0 File Offset: 0x000AD6A0
		...
		// Token: 0x0600303C RID: 12348 RVA: 0x000AF4F6 File Offset: 0x000AD6F6
		...
		// Token: 0x0600303D RID: 12349 RVA: 0x000AF526 File Offset: 0x000AD726
		...
		// Token: 0x0600303E RID: 12350 RVA: 0x000AF531 File Offset: 0x000AD731
		protected override byte[] HashFinal()
		{
			return this._EndHash();
		}

		// Token: 0x0600303F RID: 12351 RVA: 0x000AF53C File Offset: 0x000AD73C
		...
		// Token: 0x06003040 RID: 12352 RVA: 0x000AF5BC File Offset: 0x000AD7BC
		...
		// Token: 0x06003041 RID: 12353 RVA: 0x000AF6D0 File Offset: 0x000AD8D0
		...
		// Token: 0x06003042 RID: 12354 RVA: 0x000AF7BC File Offset: 0x000AD9BC
		[SecurityCritical]
		...
		// Token: 0x06003043 RID: 12355 RVA: 0x000AFAD9 File Offset: 0x000ADCD9
		private static uint RotateRight(uint x, int n)
		{
			return x >> n | x << 32 - n;
		}

		// Token: 0x06003044 RID: 12356 RVA: 0x000AFAEB File Offset: 0x000ADCEB
		private static uint Ch(uint x, uint y, uint z)
		{
			return (x & y) ^ ((x ^ uint.MaxValue) & z);
		}

		// Token: 0x06003045 RID: 12357 RVA: 0x000AFAF6 File Offset: 0x000ADCF6
		private static uint Maj(uint x, uint y, uint z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x06003046 RID: 12358 RVA: 0x000AFB03 File Offset: 0x000ADD03
		private static uint sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 7) ^ SHA256Managed.RotateRight(x, 18) ^ x >> 3;
		}

		// Token: 0x06003047 RID: 12359 RVA: 0x000AFB19 File Offset: 0x000ADD19
		private static uint sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 17) ^ SHA256Managed.RotateRight(x, 19) ^ x >> 10;
		}

		// Token: 0x06003048 RID: 12360 RVA: 0x000AFB31 File Offset: 0x000ADD31
		private static uint Sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 2) ^ SHA256Managed.RotateRight(x, 13) ^ SHA256Managed.RotateRight(x, 22);
		}

		// Token: 0x06003049 RID: 12361 RVA: 0x000AFB4C File Offset: 0x000ADD4C
		private static uint Sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 6) ^ SHA256Managed.RotateRight(x, 11) ^ SHA256Managed.RotateRight(x, 25);
		}

		// Token: 0x0600304A RID: 12362 RVA: 0x000AFB68 File Offset: 0x000ADD68
		[SecurityCritical]
		...
		// Token: 0x0600304B RID: 12363 RVA: 0x000AFBBD File Offset: 0x000ADDBD
