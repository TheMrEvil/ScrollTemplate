...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x060006F9 RID: 1785 RVA: 0x00034818 File Offset: 0x00032A18
		public override void Define()
		{
			base.Define();
			base.DeviceName = "NVIDIA Shield Controller";
			base.DeviceNotes = "NVIDIA Shield Controller on Windows 8.1";
			...
			base.Matchers = new InputDeviceMatcher[]
			{
				...
				{
					NameLiteral = "NVIDIA Controller v01.03"
				}
			};
		...
		// Token: 0x060006FA RID: 1786 RVA: 0x00034B4A File Offset: 0x00032D4A
		public NVidiaShieldWindows81UnityProfile()
		{
		}
	}
}
