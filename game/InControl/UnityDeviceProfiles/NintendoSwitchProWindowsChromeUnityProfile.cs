...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x060006BD RID: 1725 RVA: 0x0002DA18 File Offset: 0x0002BC18
		public override void Define()
		{
			base.Define();
			base.DeviceName = "Nintendo Switch Pro Controller";
			base.DeviceNotes = "Nintendo Switch Pro Controller on Windows Chrome";
			...
			base.Matchers = new InputDeviceMatcher[]
			{
				...
				{
					NameLiteral = "Pro Controller (STANDARD GAMEPAD Vendor: 057e Product: 2009)"
				},
				new InputDeviceMatcher
				{
					NameLiteral = "Wireless Gamepad (STANDARD GAMEPAD Vendor: 057e Product: 2009)"
				}
			};
		...
		// Token: 0x060006BE RID: 1726 RVA: 0x0002DFFA File Offset: 0x0002C1FA
