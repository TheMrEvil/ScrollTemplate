...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x060006CD RID: 1741 RVA: 0x0002FFC4 File Offset: 0x0002E1C4
		public override void Define()
		{
			base.Define();
			base.DeviceName = "8Bitdo NES30 Pro Controller";
			base.DeviceNotes = "8Bitdo NES30 Pro Controller on Windows";
			...
			base.Matchers = new InputDeviceMatcher[]
			{
				...
				new InputDeviceMatcher
				{
					NameLiteral = "Bluetooth Wireless Controller   "
				}
			};
		...
		// Token: 0x060006CE RID: 1742 RVA: 0x000304C1 File Offset: 0x0002E6C1
