...
namespace System.Data.SqlClient
{
	...
	{
		// Token: 0x060019B6 RID: 6582 RVA: 0x00076D2A File Offset: 0x00074F2A
		...
		// Token: 0x060019B7 RID: 6583 RVA: 0x00076D38 File Offset: 0x00074F38
				...
				while (dataReader.Read())
				{
					...
					if (array[0] != DBNull.Value && array[1] != DBNull.Value && array[2] != DBNull.Value && array[3] != DBNull.Value && array[4] != DBNull.Value && array[5] != DBNull.Value)
					{
						...
						if (array[7] != DBNull.Value)
						{
							...
							foreach (byte b in (byte[])array[7])
							{
		...
		// Token: 0x060019B8 RID: 6584 RVA: 0x00077088 File Offset: 0x00075288
		...
		// Token: 0x060019B9 RID: 6585 RVA: 0x0007720C File Offset: 0x0007540C
		...
		// Token: 0x060019BA RID: 6586 RVA: 0x00077270 File Offset: 0x00075470
